...
void EnsureWalletIsUnlocked()
{
    ...
    if (fWalletUnlockMintOnly)
        throw JSONRPCError(RPC_WALLET_UNLOCK_NEEDED, "Error: Wallet is unlocked for block miting only.");
}
...
void ThreadTopUpKeyPool(void* parg)
{
    ...
    RenameThread("JackpotCoin-key-top");
...
void ThreadCleanWalletPassphrase(void* parg)
{
    ...
    RenameThread("JackpotCoin-lock-wa");
